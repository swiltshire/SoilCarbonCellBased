...
# rothc_by_cell <- function(cell_id, gcm, gis_dat_path, gcm_dat_path, lm_dat_path) {

cell_id = 15776
gcm = "mri-cgcm3"
gis_dat_path = "input_data/cell_gis_dat_all.xlsx"
...
print(paste("*** Running spinup, cell #", params_ls$cell_id, ", ", params_ls$gcm, sep = ""))
for (lu_lab in params_ls$lu_labs) {
  # print(paste("*** Calibrating below-ground C, cell #", params_ls$cell_id, ", ", params_ls$gcm, ", ", lu_lab, sep = ""))
...
for (lu_lab in params_ls$lu_labs) {
  ...
  # print(paste("Running final spinup, cell #", params_ls$cell_id, ", ", params_ls$gcm, ", ", lu_lab, sep = ""))
...
# run the simulations
print(paste("*** Running simulation, cell #", params_ls$cell_id, ", ", params_ls$gcm, sep = ""))
for (lu_lab in params_ls$lu_labs) {
  # print(paste("Running sims, cell #", params_ls$cell_id, ", ", params_ls$gcm, ", ", lu_lab, sep = ""))
...
for (lu_lab in params_ls$lu_labs) {
  sim_dat_tib <- as_tibble(res_ls[[lu_lab]]$bau$c_stocks)
...
print(paste("*** Finished, cell #", params_ls$cell_id, ", ", params_ls$gcm, sep = ""))
write_csv(out_dat, file = paste("/glade/scratch/swiltshire/sim_data_", params_ls$gcm, '_', params_ls$cell_id, ".csv", sep = ""))
# }

## Sample function call
# rothc_by_cell(cell_id = 40604,
#               gcm = "mri-cgcm3",
#               gis_dat_path = "input_data/cell_gis_dat_all.xlsx",
#               gcm_dat_path = "input_data/mri-cgcm3_1950-2099_by_cell/",
#               lm_dat_path = "input_data/rothc_lm_in_dat.xlsx")
